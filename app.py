...
sample_race_data = [{'office':'Governor','blurb':'After two years in the governor’s office, Democrat Mark Dayton is stepping down, leaving a wide open field that has plenty of candidates clamoring to get in. On the DFL side, that includes one member of Congress, one state auditor, one big-city mayor and three legislators. For Republicans, plenty of party activists, the former party chairman, a Hennepin County Commissioner and at least one state legislator have jumped in, but the elephant in the room is if House Speaker Kurt Daudt will run.','map-id':''}, {'office':'Attorney General','blurb':'','map-id':''}, {'office':'Secretary of State','blurb':'','map-id':''}, {'office':'State Auditor','blurb':'','map-id':''}, {'office':'Senate','blurb':'','map-id':''}, {'office':'Congressional District 1','blurb':'','map-id':''}, {'office':'Congressional District 2','blurb':'','map-id':''}, {'office':'Congressional District 3','blurb':'','map-id':''}, {'office':'Congressional District 4','blurb':'','map-id':''}, {'office':'Congressional District 5','blurb':'','map-id':''}, {'office':'Congressional District 6','blurb':'','map-id':''}, {'office':'Congressional District 7','blurb':'','map-id':''}, {'office':'Congressional District 8','blurb':'','map-id':''}]
